...
# max_length = []
# for country in countries:
#     if len(country) == max(length):
#         max_length.append(country)
# print(max_length)

# min_length = []
# for country in countries:
#     if len(country) == min(length):
#         min_length.append(country)
# print(min_length)

length = [len(c) for c in countries]
# print(length)
longest_contries = [c for c in countries if len(c) == max(length) ]
print(longest_contries)
shortest_ccountries = [c for c in countries if len(c) == min(length)]
print(shortest_ccountries)